...
$id = $_GET['id'];
$tampil = $koneksi->query("SELECT * FROM bukutamu_aril WHERE no='$id'");
...
if (isset($_POST['update'])) {
    ...
    $update = $koneksi->query("UPDATE bukutamu_aril SET tanggal='$tanggal', nama='$nama', jk='$jk', alamat='$alamat', nik='$nik', umur='$umur', keperluan='$keperluan' WHERE no='$id'");
        ...
        <div class="col col-5">
            <form method="post" action="">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" name="nik" value="<?php echo $b['nik']; ?>" required>
                </div>
                <div class="mb-3">
