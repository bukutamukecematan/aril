...
include "boot.php"
?>
<body style="background-image: url(aril.jpg);
...
<nav class="navbar navbar-expand-lg bg-info-subtle">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
      ...
      <li class="nav-item">
          <a class="nav-link active" aria-current="page"h="#"><h5>BUKU TAMU KECAMATAN</h2 >
        </li>
        <li class="nav-item">
...
<li class="list-group-item bg-white">
  ...
  <!-- ini bagian content  -->
    <div class="col col- mt-2">
      <iframe src="beranda.php" frameborder="0" name="konten" width="100%" height="500"></iframe>
